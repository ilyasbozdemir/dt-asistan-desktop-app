export const DATA_TeminFirma = {
  ...
  columns: [
    ...
    { name: 'teklif_durumu', type: 'TEXT', default: "'Davet Edildi'", description: 'Teklif Durumu' },
    ...
    { name: 'yasaklilik_durumu', type: 'TEXT', default: "'Sorgulanmadı'", description: 'Yasaklılık Durumu' },
