export const DATA_TeminKalem = {
  ...
  columns: [
    ...
    { name: 'tipi', type: 'TEXT', notNull: true, default: "'Mal'", description: 'Alım Tipi (Mal/Hizmet/Yapım/Danışmanlık)' }, // Mal | Hizmet | Yapım | Danışmanlık
    { name: 'birim', type: 'TEXT', default: "'Adet'", description: 'Ölçü Birimi (Adet, Kg, Lt vb.)' },
