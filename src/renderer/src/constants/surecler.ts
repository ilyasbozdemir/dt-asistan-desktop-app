...
export const subPagesMapping: ProcessStage[] = [
  ...
  { name: 'Fiyat Araştırma Komisyonu', path: APP_ROUTES.KOMISYON_FIYAT_ARASTIRMA, icon: Users, stage: 2 },
  { name: 'Fiyat Araştırma & Muayene', path: APP_ROUTES.KOMISYON_FIYAT_MUAYENE, icon: Users, stage: 2 },
  ...
  { name: 'Piyasa Araştırma Tutanağı', path: APP_ROUTES.PIYASA_ARASTIRMA_TUTANAGI, icon: Compass, stage: 2 },
  ...
  { name: 'Muayene Kabul ve Tespit', path: APP_ROUTES.KOMISYON_MUAYENE_KABUL, icon: Users, stage: 4 },
