...
export default function DosyaScreen(): React.JSX.Element {
  ...
  const [processStats, setProcessStats] = useState({ asama1: 0, asama2: 0, asama3: 0, asama4: 0, tamamlandi: 0 })
  ...
  useEffect(() => {
    ...
    const fetchProcessStats = async () => {
      try {
        const res = await window.electron.ipcRenderer.invoke('db:query', 'SELECT durum_asama_id, COUNT(*) as count FROM DATA_TeminDosyasi GROUP BY durum_asama_id')
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <div className="bg-amber-50/50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/30 rounded-2xl p-4 flex flex-col justify-between group hover:bg-amber-50 dark:hover:bg-amber-950/40 transition-colors">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-2xl font-black text-amber-700 dark:text-amber-500">{processStats.asama1}</span>
                </div>
                <div>
                  <h3 className="font-bold text-xs text-amber-900 dark:text-amber-400">1. İhtiyaç & Başlangıç</h3>
                  <p className="text-[10px] text-amber-700/70 dark:text-amber-500/70 mt-1 line-clamp-2">Teknik şartname ve yaklaşık maliyet öncesi.</p>
                </div>
              </div>
              {/* Aşama 2 */}
              <div className="bg-blue-50/50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900/30 rounded-2xl p-4 flex flex-col justify-between group hover:bg-blue-50 dark:hover:bg-blue-950/40 transition-colors">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-2xl font-black text-blue-700 dark:text-blue-500">{processStats.asama2}</span>
                </div>
                <div>
                  <h3 className="font-bold text-xs text-blue-900 dark:text-blue-400">2. Fiyat Araştırması</h3>
                  <p className="text-[10px] text-blue-700/70 dark:text-blue-500/70 mt-1 line-clamp-2">Piyasa tekliflerinin toplanması ve komisyon süreci.</p>
                </div>
              </div>
              {/* Aşama 3 */}
              <div className="bg-purple-50/50 dark:bg-purple-950/20 border border-purple-200 dark:border-purple-900/30 rounded-2xl p-4 flex flex-col justify-between group hover:bg-purple-50 dark:hover:bg-purple-950/40 transition-colors">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-2xl font-black text-purple-700 dark:text-purple-500">{processStats.asama3}</span>
                </div>
                <div>
                  <h3 className="font-bold text-xs text-purple-900 dark:text-purple-400">3. Sipariş & Sözleşme</h3>
                  <p className="text-[10px] text-purple-700/70 dark:text-purple-500/70 mt-1 line-clamp-2">Onay belgesi ve firmaya işin tebliğ edilmesi.</p>
                </div>
              </div>
              {/* Aşama 4 */}
              <div className="bg-emerald-50/50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-900/30 rounded-2xl p-4 flex flex-col justify-between group hover:bg-emerald-50 dark:hover:bg-emerald-950/40 transition-colors">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-2xl font-black text-emerald-700 dark:text-emerald-500">{processStats.asama4}</span>
                </div>
                <div>
                  <h3 className="font-bold text-xs text-emerald-900 dark:text-emerald-400">4. Kabul & Ödeme</h3>
                  <p className="text-[10px] text-emerald-700/70 dark:text-emerald-500/70 mt-1 line-clamp-2">Muayene kabul ve ödeme emri belgelerinin kesimi.</p>
                </div>
              </div>
              {/* Tamamlandı */}
              <div className="bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/60 rounded-2xl p-4 flex flex-col justify-between group hover:bg-slate-100 dark:hover:bg-slate-800/80 transition-colors">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-2xl font-black text-slate-700 dark:text-slate-400">{processStats.tamamlandi}</span>
                </div>
                <div>
                  <h3 className="font-bold text-xs text-slate-700 dark:text-slate-300">Arşivlenen İşler</h3>
                  <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-1 line-clamp-2">Süreci tamamlanıp arşive kaldırılan teminler.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200">Sistem ve Teknik Detaylar</h3>
                <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5">Arşiv yapısı, veritabanı yedeği (DTE) ve sistem güncellemeleri</p>
              </div>
            </div>
