...
import { Star, FileText, Plus, ArrowRight, Trash2, FolderOpen } from 'lucide-react'
          ...
          {dosyalarLoading ? (
            ...
            <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 text-center">
              ...
              <p className="text-slate-500 text-sm">
                Aktif dosyalarınızda çalışırken evrakları "Hızlı Erişime Ekle" butonu ile
