        ...
        <div className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 p-4 rounded-2xl flex items-start gap-3.5 shadow-sm">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
              Her süreç adımı için kullanılacak şablon belgesini ve veritabanı değişken eşleşmelerini bu ekrandan yönetebilirsiniz.
              Aşama listesini genişletmek veya gizlemek için aşama kartlarının başlıklarına tıklayabilirsiniz.
            </p>
          </div>
        </div>
      </div>
